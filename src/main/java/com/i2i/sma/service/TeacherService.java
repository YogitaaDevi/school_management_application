...
public class TeacherService {
     ...
     *
     * @return
     *   all Teacher details in form of list to display it to the enduser.
     * @throws SchoolManagementException
     ...
     * @return
     *   the teacher object corresponding to the provided ID, or null if no such student is found
     * @throws SchoolManagementException
     ...
     * @return
     *   true if the teacher is deleted successfully or else returns false.
     * @throws SchoolManagementException
