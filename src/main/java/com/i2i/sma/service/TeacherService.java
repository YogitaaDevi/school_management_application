...
public class TeacherService implements TeacherServiceInterface {
     ...
     *
     * @param name    teacher's name in string. Only alphabets are allowed
     * @param subject teacher's handling subject in string. Only alphabets are allowed
     * @param grades  contains standard and section along with their grade id that the teacher is associated with it.
     * @return teacher
     ...
     */
    public Optional<Teacher> findTeacher(int id) throws SchoolManagementException {
