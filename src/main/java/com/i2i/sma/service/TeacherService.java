...
public class TeacherService {
     ...
     * @param grade.   contains standard and section along with their grade id that the teacher is associated with it.
     * @return teacher
     ...
     * @return returns true if the teacher is deleted successfully or else returns false.
