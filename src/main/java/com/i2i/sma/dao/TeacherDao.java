...
public class TeacherDao {
    ...
    * </p>
    * @param teacher 
    *     the teacher objects contains three things - 1. name of the teacher in string. Only alphabets are allowed.
    ...
    * @return 
    *     returns true if the particular teacher record is deleted.Else returns false. 
    * @throws SchoolManagementException 
