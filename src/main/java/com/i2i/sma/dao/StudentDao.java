 ...
 * It provides functionalities to add new students, fetch all student records, search for students,
...
public class StudentDao {
    ...
    /**
     * <p>
     * This method makes use of the Hibernate query language inorder to
     ...
     * to retrieve all student records from the database.
     * </p>
     *
