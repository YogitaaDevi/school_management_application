...
public class StudentDao {
    ...
    * </p>
    * @param student 
    *     the student contains three things - 1. name of the student in string. Only alphabets are allowed.
    ...
    * @return 
    *     Student data along with their class details if the ID is available. Else returns a empty student.
    * @throws SchoolManagementException 
